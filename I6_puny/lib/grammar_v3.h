...
Verb 'parler'
   * 'a'/'avec' creature                             -> TalkTo
   * creature                                        -> TalkTo
   * 'a'/'avec' creature 'de'/'des' topic            -> Tell
   * creature 'de'/'des' topic                       -> Tell
;
#Ifnot;
Verb 'parler'
   * 'a'/'avec' creature 'de'/'des' topic            -> Tell
...
!   * 'a'/'en'/'vers' noun=ADirection                -> Examine ! compass_look
   * 'a' 'travers' noun                              -> Search
!   * 'sous' noun                                     -> LookUnder
!   * topic 'a'/'sur'/'dans' noun                    -> Consult
;
...
Verb 'aller'
   * 'a'/'en'/'vers' noun=ADirection                 -> Go
   * 'a'/'sur'/'dans'/'sous' noun                    -> Enter
;
...
Verb 'sortir'
   *                                                 -> GoOut ! de_là/d'ici
   * multiinside 'de'/'des' noun                     -> Remove
   * 'de'/'des' noun                                 -> Exit
   * 'par' noun                                      -> Enter !Exit?
;
...
Verb 'monter'
   *                                                 -> sGoUp
   * 'a'/'sur'/'dans'/'par'/'en' noun                -> Enter
;

Verb 'descendre' 'd//'
   *                                                 -> sGetOff
   * 'de'/'des' noun                                 -> GetOff
   * 'a'/'sur'/'dans'/'par' noun                     -> Enter
;

Verb 'grimper'
   * 'sur'/'a'/'dans'/'par' noun                     -> Enter
;
...
Verb 'prendre'
   ...
   * multiinside 'de'/'des'/'dans'/'sur' noun        -> Remove
;
...
Verb 'lancer' 'jeter' !WARNING diffère de l’original
   * noun                                            -> ThrowAt
   * held 'a' noun                                   -> ThrowAt
   * held 'sur'/'dans'/'contre'/'par'
                               /'par-dessus' noun    -> ThrowAt
...
Verb 'pousser'
   * noun                                            -> Push
   * noun 'a'/'en'/'vers' noun                       -> PushDir !contre?
