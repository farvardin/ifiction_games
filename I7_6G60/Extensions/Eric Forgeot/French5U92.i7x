...
Carry out rubbing it with:
	say "[if using the French 3PSP Language option]Il n'arriva à rien ainsi.[otherwise if using the French 1PSP Language option]Je n'arrivai à rien comme ça.[otherwise]Vous n'arrivez à rien comme ça.[end if]".
...
Example: * Le Roi de Fihnargaia - Un petit exemple de jeu en français.
	...
	*: "Le Roi de Fihnargaia" by Eric
	
Include French by Eric Forgeot.
Use French Language.

The Grand Hall de Fihnargaia is a room. "Le Grand Hall de Fihnargaia est luxueusement meublé. L'unique sortie est au sud."

The Petit Couloir is south from Grand Hall de Fihnargaia. The description of Petit Couloir is "Les murs sont couverts de lampes brillants de mille feux. Au nord se trouve le grand hall où vous attend le roi, tandis que le couloir où vous vous trouvez actuellement oblique vers l[']est."
