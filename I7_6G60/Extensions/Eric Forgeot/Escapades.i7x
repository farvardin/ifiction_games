Version 3/201103 of Escapades by Eric Forgeot begins here. [2020-04-17]

"A simple RPG system."

[License: CC-BY-SA https://creativecommons.org/licenses/by-sa/2.0/fr/]

[designed for Inform7 6G60, should be compatible with 6L##]
...
To say ScoreCaract:
	say "[if the French option is active]Caractéristiques : [otherwise]Caracteristics: [end if]".
...
Getting the score is an action out of world and applying to nothing.

Understand the command "score" as something new.

Understand "score" as getting the score.

Carry out getting the score:
	say "Score : [score][line break]";
	[say "[line break][ScoreCaract]";]
...
Rule for listing the stats of a thing (called character):
	...
	say "[line break]Bonus CC: [bonus CC of character]";
	say "[line break]CC opposition: [CCombatOpposition of character]";
